...
CHUNK_OVERLAP = 30
TIMEOUT = 120
DEBUG = True  # Show preview of model output
...
<List database tables, files, or entities involved, including their actual names>
...
List **all** input field validations:
1. Required fields
2. Allowed values
3. Error messages
4. Conditional logic
...
## Existence Checking
<Related record checks or validations>
"""
...
def is_structured_output(text):
    """Allow flexibility in header naming"""
    sections = [
        "## Identification",
        "## Description",
        "## Process Steps",
