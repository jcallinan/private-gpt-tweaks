...
def process_chunk(i, chunk, template, ap200_context, outdir, logdir, rawfile):
...
if __name__ == "__main__":
    ...
    outdir = os.path.join(OUTPUT_BASE, f"mistral_debug_{ts}")
